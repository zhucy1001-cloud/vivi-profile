const profileData = {
    ...
    // 活动案例数据库（以后想加第5个案例，在这里直接复制加一行即可）
    cases: [
        {
            id: "case-auto",
            ...
            features: ["精准把握产品亮点与车企品牌内涵", "掌控科技发布会高质感节奏", "与高管嘉宾及车主现场流畅互动"]
        },
        {
            id: "",
            ...
            features: ["驾驭千人户外盛典热烈欢庆气氛", "双主持搭档控场，提调盛典高潮", "庄重得体的仪式感引导与剪彩把控"]
        },
        {
            id: "",
            ...
            features: ["极强的舞台亲和力与现场调动能力", "抽奖互动与环节衔接自然流畅", "营造温馨高雅的节日尊享体验"]
        },
        {
            id: "case-talk",
            ...
            features: ["熟练掌握政企商务会议流程与学术研讨气氛", "展现主持人多变且灵活的控场风格"]
        }
    ]
};
