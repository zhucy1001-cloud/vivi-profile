const profileData = {
    ...
    cases: [
        ...
        },
        {
            ...
            title: "政企培训与专题研讨会议",
            image: "event4.jpg",
            sceneImage: "event4现场.jpg",
            desc: "知性干练主持商务会议与专题培训，如常州市商务局主办的直播电商人才培育工程，熟练把控学术与政企研讨氛围。",
            features: [
                "熟练掌握政企商务会议流程与学术研讨气氛",
                "展现主持人多变且灵活的控场风格"
            ]
        ...
        {
            id: "case-cultural",
            tag: "CULTURAL & FESTIVAL TOURISM",
            title: "文旅品牌节庆与亲子互动活动",
            image: "event5.jpg",
            sceneImage: "event5现场.jpg",
            desc: "完美驾驭“童心未泯·粽情守护”等大型户外文旅节日活动。通过充满亲和力的现场互动与趣味游戏，将传统节日与欢乐氛围推向高潮。",
            features: [
                "精准活跃文旅户外节庆的欢快热烈气氛",
                "擅长与现场亲子家庭、大众进行零距离趣味互动",
                "高情商应变与全场节奏把控力"
            ]
        }
    ]
